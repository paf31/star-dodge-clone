...
(function(exports) {
  ...
  var concatMap = function (f) {
      return function (_348) {
          if (_348 instanceof Nil) {
              return Nil.value;
          };
          if (_348 instanceof Cons) {
              return Prelude["<>"](semigroupList)(f(_348.value0))(concatMap(f)(_348.value1));
          };
          throw new Error("Failed pattern match: " + [ f.constructor.name, _348.constructor.name ]);
      };
  };                                                       
...
(function(exports) {
  ...
  var main = function __do() {
      ...
      if (_8 instanceof Data_Maybe.Just) {
          ...
          var _6 = Prelude["<$>"](Control_Monad_Eff.functorEff)(Control_Bind.join(Data_List.bindList))(Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_List.traversableList)(Data_List[".."](0)(8))(function (x) {
              return Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_List.traversableList)(Data_List[".."](2)(6))(function (y) {
                  return function __do() {
                      ...
                      return Prelude["return"](Control_Monad_Eff.applicativeEff)({
                          x: 0.15 + (Data_Int.toNumber(x) * 0.7) / 8.0 + _3, 
                          y: 0.15 + (Data_Int.toNumber(y) * 0.7) / 8.0 + _2
                      })();
                  };
              });
          }))();
          ...
          var renderPaths = function (paths) {
              return function __do() {
                  ...
                  return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_List.foldableList)(paths)(function (path) {
                      ...
                      throw new Error("Failed pattern match at Main line 176, column 7 - line 177, column 7: " + [ path.constructor.name ]);
                  })();
              };
          };
              ...
              return function (inputs) {
                  return new Playing({
                      ...
                      direction: (function () {
                          ...
                          throw new Error("Failed pattern match at Main line 71, column 1 - line 186, column 30: " + [ inputs.space.constructor.name ]);
                      })()
                  });
              };
          };
              ...
              return function (space_1) {
                  if (pt.x < 0.9480000000000001) {
                      var dy = (function () {
                          ...
                          throw new Error("Failed pattern match at Main line 136, column 17 - line 137, column 13: " + [ space_1.constructor.name ]);
                      })();
                  ...
                  throw new Error("Failed pattern match at Main line 71, column 1 - line 186, column 30: " + [ pt.constructor.name, space_1.constructor.name ]);
              };
          };
          ...
          var testLineSegments = function (q1) {
              return function (q2) {
                  var go = function (__copy__14) {
                      var _14 = __copy__14;
                      tco: while (true) {
                          if (_14 instanceof Data_List.Cons && _14.value1 instanceof Data_List.Cons) {
                              if (linesIntersect(_14.value0)(_14.value1.value0)(q1)(q2)) {
                                  return true;
                              };
                              if (Prelude.otherwise) {
          ...
          var testCollision = function (_11) {
              if (_11 instanceof Data_List.Cons && (_11.value0 instanceof Data_List.Cons && _11.value0.value1 instanceof Data_List.Cons)) {
                  if (_11.value0.value0.y <= 0.25) {
                      return true;
                  };
                  if (_11.value0.value0.y >= 0.75) {
                      return true;
                  };
                  if (Data_Foldable.any(Data_List.foldableList)(Prelude.booleanAlgebraBoolean)(Prelude["<<<"](Prelude.semigroupoidFn)(function (_1) {
                      return _1 < 2.25e-4;
                  })(dist2(_11.value0.value0)))(_6)) {
                      return true;
                  };
                  if (Data_Foldable.any(Data_List.foldableList)(Prelude.booleanAlgebraBoolean)(testLineSegments(_11.value0.value0)(_11.value0.value1.value0))(_11.value1)) {
                      return true;
                  };
                  if (Prelude.otherwise) {
                      return false;
              ...
              throw new Error("Failed pattern match at Main line 71, column 1 - line 186, column 30: " + [ _11.constructor.name ]);
          };
          ...
          var state = (function () {
              var update = function (inputs_1) {
                  return function (_13) {
                      if (_13 instanceof Playing && (_13.value0.paths instanceof Data_List.Cons && _13.value0.paths.value0 instanceof Data_List.Cons)) {
                          if (testCollision(_13.value0.paths)) {
                              return new GameOver(_13.value0.paths);
                          };
                          if (Prelude["=="](Prelude.eqBoolean)(Prelude["=="](eqDirection)(_13.value0.direction)(Up.value))(inputs_1.space)) {
                              var _45 = move(_13.value0.paths.value0.value0)(inputs_1.space);
                              if (_45 instanceof Data_Either.Right) {
                                  return playing(new Data_List.Cons(new Data_List.Cons(_45.value0, _13.value0.paths.value0.value1), _13.value0.paths.value1))(inputs_1);
                              };
                              if (_45 instanceof Data_Either.Left) {
                                  return playing(Data_List.take(3)(new Data_List.Cons(Data_List.toList(Data_Foldable.foldableArray)([ _45.value0.value1, _45.value0.value1 ]), new Data_List.Cons(new Data_List.Cons(_45.value0.value0, _13.value0.paths.value0.value1), _13.value0.paths.value1))))(inputs_1);
                              };
                              throw new Error("Failed pattern match at Main line 95, column 9 - line 96, column 9: " + [ _45.constructor.name ]);
                          };
                          if (Prelude.otherwise) {
                              return playing(new Data_List.Cons(new Data_List.Cons(_13.value0.paths.value0.value0, new Data_List.Cons(_13.value0.paths.value0.value0, _13.value0.paths.value0.value1)), _13.value0.paths.value1))(inputs_1);
                          };
                      };
                      if (_13 instanceof GameOver) {
                          ...
                          if (!inputs_1.space) {
                              return new GameOver(_13.value0);
                          };
                          throw new Error("Failed pattern match at Main line 95, column 9 - line 96, column 9: " + [ inputs_1.space.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Main line 95, column 9 - line 96, column 9: " + [ inputs_1.constructor.name, _13.constructor.name ]);
                  };
              };
          ...
          var render = function (_12) {
              if (_12 instanceof GameOver) {
                  return Prelude["void"](Control_Monad_Eff.functorEff)(function __do() {
                      background();
                      return renderPaths(_12.value0)();
                  });
              };
              if (_12 instanceof Playing) {
                  return Prelude["void"](Control_Monad_Eff.functorEff)(function __do() {
                      background();
                      return renderPaths(_12.value0.paths)();
                  });
              };
              throw new Error("Failed pattern match at Main line 71, column 1 - line 186, column 30: " + [ _12.constructor.name ]);
          };
          return Signal.runSignal(Prelude["<$>"](Signal.functorSignal)(render)(state))();
      };
      throw new Error("Failed pattern match at Main line 71, column 1 - line 186, column 30: " + [ _8.constructor.name ]);
  };
