...
n.randomRange(-0.025)(0.025)(),g=n.randomRange(-0.025)(0.025)();return b["return"](f.applicativeEff)({x:0.15+0.7*e.toNumber(a.value0)/8+c,y:0.15+0.7*e.toNumber(a.value1)/8+g,r:d})()}})();return b["return"](f.applicativeEff)({stars:a,door:g,speed:c})()}}())},I=b["<$>"](m.functorList)(C)(m.iterate(b["+"](b.semiringInt)(1))(0)),J=function(a){return function(c){return function(d){if(b[">"](a)(c)(d))return d;if(b.otherwise)return c;throw Error("Failed pattern match at Main line 81, column 1 - line 82, column 1: "+
[c.constructor.name,d.constructor.name]);}}};a.Playing=v;a.Waiting=x;a.Up=y;a.Down=w;a.main=function(){var a=h.getCanvasElementById("canvas")();if(a instanceof r.Just){var e=h.getContext2D(a.value0)(),g=p.newRef({space:!1})();c.onSpaceBar(function(a){return p.modifyRef(g)(function(b){var c={},d;for(d in b)b.hasOwnProperty(d)&&(c[d]=b[d]);c.space=a;return c})})();h.translate({translateX:0,translateY:-170})(e)();h.scale({scaleX:800,scaleY:800})(e)();h.setLineWidth(0.001)(e)();var l=function(a){return function(c){if(c instanceof
k.Cons&&c.value1 instanceof k.Cons){if(0.25>=c.value0.y||0.75<=c.value0.y||0.95<c.value0.x&&(c.value0.y<0.5-a.door/2||c.value0.y>0.5+a.door/2)||s.any(k.foldableList)(b.booleanAlgebraBoolean)(function(a){return H(c.value0)(a)<a.r*a.r})(a.stars))return!0;if(b.otherwise)return!1}throw Error("Failed pattern match at Main line 211, column 7 - line 212, column 7: "+[a.constructor.name,c.constructor.name]);}},n=function(a){return function(){h.setStrokeStyle("lightgreen")(e)();return a instanceof k.Cons?
b["void"](f.functorEff)(function(){h.beginPath(e)();h.moveTo(e)(a.value0.x)(a.value0.y)();s.for_(f.applicativeEff)(k.foldableList)(a.value1)(function(a){return h.lineTo(e)(a.x)(a.y)})();return h.stroke(e)()})():b["return"](f.applicativeEff)(b.unit)()}},z=function(a){return function(b){return function(c){if(c.space)c=y.value;else{if(c.space)throw Error("Failed pattern match at Main line 105, column 1 - line 227, column 28: "+[c.space.constructor.name]);c=w.value}return new v({path:a,level:b,direction:c})}}},
B=function(a){return function(c){return function(d){return function(e){var f;if(d)f=1;else{if(d)throw Error("Failed pattern match at Main line 158, column 13 - line 161, column 9: "+[d.constructor.name]);f=-1}e=J(b.ordNumber)(e)(50);var g={x:c.x+a.speed*e,y:c.y+f*a.speed*e};return b.bind(r.bindMaybe)(u.guard(r.monadPlusMaybe)(0.95>g.x||g.y<0.5-a.door/2||g.y>0.5+a.door/2))(function(){return b["return"](r.applicativeMaybe)(g)})}}}},A=function(a){return new x({path:k.Nil.value,nextLevel:a})},D=function(a){return function(c){return function(d){if(d instanceof
v&&d.value0.path instanceof k.Cons){if(l(q.fromJust(m.head(d.value0.level)))(d.value0.path))return r.Just.create(new x({path:d.value0.path,nextLevel:d.value0.level}));if(b["=="](b.eqBoolean)(b["=="](G)(d.value0.direction)(y.value))(a.space)){var e=B(q.fromJust(m.head(d.value0.level)))(d.value0.path.value0)(a.space)(c);if(e instanceof r.Just)return r.Just.create(z(new k.Cons(e.value0,d.value0.path.value1))(d.value0.level)(a));if(e instanceof r.Nothing)return r.Just.create(A(q.fromJust(m.tail(d.value0.level))));
throw Error("Failed pattern match at Main line 105, column 1 - line 227, column 28: "+[e.constructor.name]);}if(b.otherwise)return r.Just.create(z(new k.Cons(d.value0.path.value0,new k.Cons(d.value0.path.value0,d.value0.path.value1)))(d.value0.level)(a))}if(d instanceof x){if(a.space){e=r.Just;d=d.value0.nextLevel;var f={x:0.05,y:0.5};d=new v({path:k.toList(s.foldableArray)([f,f]),direction:w.value,level:d});return new e(d)}if(!a.space)return r.Nothing.value;throw Error("Failed pattern match at Main line 105, column 1 - line 227, column 28: "+
[a.space.constructor.name]);}throw Error("Failed pattern match at Main line 105, column 1 - line 227, column 28: "+[a.constructor.name,c.constructor.name,d.constructor.name]);}}},C=function(a){return b["void"](f.functorEff)(function(){var b=q.fromJust(m.head(a));return function(){h.setFillStyle("black")(e)();h.fillRect(e)({x:0,y:0,w:1,h:1})();h.setStrokeStyle("lightgreen")(e)();h.strokeRect(e)({x:0.05,y:0.25,w:0.9,h:0.5})();h.strokeRect(e)({x:0.045,y:0.24500000000000002,w:0.9099999999999999,h:0.51})();
h.setFillStyle("lightgreen")(e)();h.fillRect(e)({x:0.045,y:0.5-b.door/2,w:0.005,h:b.door})();h.fillRect(e)({x:0.95,y:0.5-b.door/2,w:0.005,h:b.door})();h.setFillStyle("#222")(e)();h.setStrokeStyle("lightgreen")(e)();return s.for_(f.applicativeEff)(k.foldableList)(b.stars)(function(a){var b=function(){h.arc(e)({x:a.x,y:a.y,r:a.r,start:0,end:2*d.pi})();return h.closePath(e)()};return function(){h.fillPath(e)(b)();return h.strokePath(e)(b)()}})()}}())},K=function(a){if(a instanceof x)return b["void"](f.functorEff)(function(){C(a.value0.nextLevel)();
return n(a.value0.path)()});if(a instanceof v)return b["void"](f.functorEff)(function(){C(a.value0.level)();return n(a.value0.path)()});throw Error("Failed pattern match at Main line 105, column 1 - line 227, column 28: "+[a.constructor.name]);};return function(a){var c=function(a){return function(){var d=t.nowEpochMilliseconds(),e=p.readRef(g)();return E.requestAnimationFrame(function(){var f=t.nowEpochMilliseconds();return function(){var g=D(e)(b["-"](F.ringMilliseconds)(f)(d))(a);if(g instanceof
r.Just)return function(){K(g.value0)();return c(g.value0)()};if(g instanceof r.Nothing)return c(a);throw Error("Failed pattern match at Main line 105, column 1 - line 227, column 28: "+[g.constructor.name]);}()()})()}};return function(){K(a)();return c(a)()}}(A(I))()}throw Error("Failed pattern match at Main line 105, column 1 - line 227, column 28: "+[a.constructor.name]);};a.levels=I;a.unsafeLevel=C;a.clamp=J;a.decay=z;a.subtract=A;a.len2=D;a.dist2=H;a.eqDirection=G;a.onSpaceBar=c.onSpaceBar})(PS.Main=
PS.Main||{});
