...
q.randomRange(-h)(h)(),e=q.randomRange(-h)(h)();return b["return"](g.applicativeEff)({x:100+75*f.toNumber(a.value0)+c,y:100+70*f.toNumber(a.value1)+e,r:d})()}})(),k=q.randomRange(50+e/2)(450-e/2)(),l=q.randomRange(50+e/2)(450-e/2)();return b["return"](g.applicativeEff)({stars:a,door:e,speed:c,entry:k,exit:l})()}}())},N=b["<$>"](h.functorList)(J)(h.iterate(b["+"](b.semiringInt)(1))(0)),O=function(a){return function(c){return function(d){if(b[">"](a)(c)(d))return d;if(b.otherwise)return c;throw Error("Failed pattern match at Main line 87, column 1 - line 88, column 1: "+
