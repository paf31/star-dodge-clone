...
(function(a){var c=PS.Prelude,b=function(){function a(){}a.value=new a;return a}(),d=function(){function a(){}a.value=new a;return a}(),e=function(){function a(){}a.value=new a;return a}(),f=function(a){this.compose=a},g=function(a,c){this["__superclass_Prelude.Semigroupoid_0"]=a;this.id=c},l=function(a,c,b,r){this.add=a;this.mul=c;this.one=b;this.zero=r},k=function(a){this.eq=a},n=function(a,c){this["__superclass_Prelude.Eq_0"]=a;this.compare=c},m=function(a,c){this.bottom=a;this.top=c},h=function(a,
c,b,r){this["__superclass_Prelude.Bounded_0"]=a;this.conj=c;this.disj=b;this.not=r},p=c.unsafeCompareImpl(b.value)(e.value)(d.value),q={},r=new l(c.intAdd,c.intMul,1,0),t=new f(function(a){return function(c){return function(b){return a(c(b))}}}),s=function(a){return a.pure},E=new k(c.refEq),v=new n(function(){return E},p),B=new k(c.refEq),F=function(a){return function(c){return a}},y=new g(function(){return t},function(a){return a}),w=new m(!1,!0),c=new h(function(){return w},c.boolAnd,c.boolOr,c.boolNot),
u=function(a){return a.bind},x=function(a){return a.apply};a.LT=b;a.GT=d;a.EQ=e;a.BooleanAlgebra=h;a.Bounded=m;a.Ord=n;a.Eq=k;a.Ring=function(a,c){this["__superclass_Prelude.Semiring_0"]=a;this.sub=c};a.Semiring=l;a.Semigroup=function(a){this.append=a};a.Monad=function(a,c){this["__superclass_Prelude.Applicative_0"]=a;this["__superclass_Prelude.Bind_1"]=c};a.Bind=function(a,c){this["__superclass_Prelude.Apply_0"]=a;this.bind=c};a.Applicative=function(a,c){this["__superclass_Prelude.Apply_0"]=a;this.pure=
...
a.eq=function(a){return a.eq};a["-"]=function(a){return a.sub};a.sub=function(a){return a.sub};a["+"]=function(a){return a.add};a.one=function(a){return a.one};a.mul=function(a){return a.mul};a.zero=function(a){return a.zero};a.add=function(a){return a.add};a["<>"]=function(a){return a.append};a.append=function(a){return a.append};a.ap=function(a){return function(c){return function(b){return u(a["__superclass_Prelude.Bind_1"]())(c)(function(c){return u(a["__superclass_Prelude.Bind_1"]())(b)(function(b){return s(a["__superclass_Prelude.Applicative_0"]())(c(b))})})}}};
a["return"]=s;a.bind=u;a.liftA1=function(a){return function(c){return function(b){return x(a["__superclass_Prelude.Apply_0"]())((0,a.pure)(c))(b)}}};a.pure=function(a){return a.pure};a["<*>"]=x;a.apply=function(a){return a.apply};a["void"]=function(a){return function(c){return(0,a.map)(F(q))(c)}};a["<$>"]=function(a){return a.map};a.map=function(a){return a.map};a.id=function(a){return a.id};a["<<<"]=function(a){return a.compose};a.compose=function(a){return a.compose};a.otherwise=!0;a["const"]=F;
a.flip=function(a){return function(c){return function(b){return a(b)(c)}}};a.unit=q;a.semigroupoidFn=t;a.categoryFn=y;a.semiringInt=r;a.eqBoolean=B;a.eqNumber=E;a.ordNumber=v;a.boundedBoolean=w;a.booleanAlgebraBoolean=c})(PS.Prelude=PS.Prelude||{});(function(a){a.Alt=function(a,b){this["__superclass_Prelude.Functor_0"]=a;this.alt=b};a.alt=function(a){return a.alt}})(PS["Control.Alt"]=PS["Control.Alt"]||{});
...
q=new b.Alt(function(){return k},function(a){return function(c){return a instanceof g?c:a}}),r=new f.Plus(function(){return q},g.value),t=new d.Alternative(function(){return r},function(){return h}),b=new e.MonadPlus(function(){return t},function(){return p});a.Nothing=g;a.Just=l;a.functorMaybe=k;a.applyMaybe=n;a.applicativeMaybe=h;a.altMaybe=q;a.plusMaybe=r;a.alternativeMaybe=t;a.bindMaybe=m;a.monadMaybe=p;a.monadPlusMaybe=b})(PS["Data.Maybe"]=PS["Data.Maybe"]||{});
...
(function(a){var c=PS["Data.Foldable"],b=PS.Prelude,d=PS["Data.Monoid"],e=PS["Control.Apply"],f=PS["Data.Monoid.Disj"],g=function(a,c,b){this.foldMap=a;this.foldl=c;this.foldr=b},l=function(a){return function(c){return function(f){return(0,c.foldr)(b["<<<"](b.semigroupoidFn)(e["*>"](a["__superclass_Prelude.Apply_0"]()))(f))(b.pure(a)(b.unit))}}},k=new g(function(a){return function(c){return function(f){return(0,k.foldr)(function(f){return function(d){return b["<>"](a["__superclass_Prelude.Semigroup_0"]())(c(f))(d)}})(d.mempty(a))(f)}}},
...
b.constructor.name]);}}),n=function(a){return function(b){if(a===b)return l(a);if(c.otherwise)return function(a){return function(b){return function(r){return function(f){var d=a,e=b,t=r,h=f;a:for(;;){if(d===e)return new g(d,h);if(c.otherwise){f=d+t|0;h=new g(d,h);d=f;continue a}throw Error("Failed pattern match at Data.List line 137, column 1 - line 138, column 1: "+[d.constructor.name,e.constructor.name,t.constructor.name,h.constructor.name]);}}}}}(b)(a)(function(){var c=a>b;if(c)return 1;if(!c)return-1;
throw Error("Failed pattern match at Data.List line 137, column 1 - line 138, column 1: "+[c.constructor.name]);}())(f.value);throw Error("Failed pattern match at Data.List line 137, column 1 - line 138, column 1: "+[a.constructor.name,b.constructor.name]);}},m=new c.Functor(function(a){return function(b){if(b instanceof f)return f.value;if(b instanceof g)return new g(a(b.value0),c["<$>"](m)(a)(b.value1));throw Error("Failed pattern match: "+[a.constructor.name,b.constructor.name]);}}),h=new b.Foldable(function(a){return function(d){return function(s){if(s instanceof
f)return e.mempty(a);if(s instanceof g)return c["<>"](a["__superclass_Prelude.Semigroup_0"]())(d(s.value0))(b.foldMap(h)(a)(d)(s.value1));throw Error("Failed pattern match: "+[d.constructor.name,s.constructor.name]);}}},function(a){return function(c){return function(d){if(d instanceof f)return c;if(d instanceof g)return b.foldl(h)(a)(a(c)(d.value0))(d.value1);throw Error("Failed pattern match: "+[a.constructor.name,c.constructor.name,d.constructor.name]);}}},function(a){return function(c){return function(d){if(d instanceof
...
(function(a){a.onSpaceBar=function(a){return function(){window.addEventListener("keydown",function(b){32===b.keyCode&&a(!0)()},!1);window.addEventListener("keyup",function(b){32===b.keyCode&&a(!1)()},!1)}}})(PS.Main=PS.Main||{});
(function(a){var c=PS.Main,b=PS.Prelude,d=PS.Math,e=PS["Data.Int"],f=PS["Control.Monad.Eff"],g=PS["Control.Monad.Eff.Unsafe"],l=PS["Data.Traversable"],k=PS["Data.List"],n=PS["Control.Monad.Eff.Random"],m=PS["Data.List.Lazy"],h=PS["Graphics.Canvas"],p=PS["Control.Monad.Eff.Ref"],q=PS["Data.Maybe.Unsafe"],r=PS["Data.Foldable"],t=PS["Control.MonadPlus"],s=PS["Data.Date"],E=PS["DOM.RequestAnimationFrame"],v=PS["Data.Maybe"],B=PS["Data.Tuple"],F=PS["Data.Time"],y=function(){function a(){}a.value=new a;
return a}(),w=function(){function a(){}a.value=new a;return a}(),u=function(){function a(b){this.value0=b}a.create=function(b){return new a(b)};return a}(),x=function(){function a(b){this.value0=b}a.create=function(b){return new a(b)};return a}(),A=function(a){return function(b){return{x:a.x-b.x,y:a.y-b.y}}},D=function(a){return a.x*a.x+a.y*a.y},G=new b.Eq(function(a){return function(b){return a instanceof y&&b instanceof y||a instanceof w&&b instanceof w?!0:!1}}),H=function(a){return function(b){return D(A(b)(a))}},
...
n.randomRange(-0.025)(0.025)(),g=n.randomRange(-0.025)(0.025)();return b["return"](f.applicativeEff)({x:0.15+0.7*e.toNumber(a.value0)/8+c,y:0.15+0.7*e.toNumber(a.value1)/8+g,r:d})()}})();return b["return"](f.applicativeEff)({stars:a,door:g,speed:c})()}}())},I=b["<$>"](m.functorList)(C)(m.iterate(b["+"](b.semiringInt)(1))(0)),J=function(a){return function(c){return function(d){if(b[">"](a)(c)(d))return d;if(b.otherwise)return c;throw Error("Failed pattern match at Main line 86, column 1 - line 87, column 1: "+
[c.constructor.name,d.constructor.name]);}}};a.Playing=u;a.Waiting=x;a.Up=y;a.Down=w;a.main=function(){var a=h.getCanvasElementById("canvas")();if(a instanceof v.Just){var e=h.getContext2D(a.value0)(),g=p.newRef({space:!1})();c.onSpaceBar(function(a){return p.modifyRef(g)(function(b){var c={},d;for(d in b)b.hasOwnProperty(d)&&(c[d]=b[d]);c.space=a;return c})})();h.translate({translateX:0,translateY:-170})(e)();h.scale({scaleX:800,scaleY:800})(e)();h.setLineWidth(0.001)(e)();var l=function(a){return function(c){if(c instanceof
k.Cons&&c.value1 instanceof k.Cons){if(0.25>=c.value0.y||0.75<=c.value0.y||0.95<c.value0.x&&(c.value0.y<0.5-a.door/2||c.value0.y>0.5+a.door/2)||r.any(k.foldableList)(b.booleanAlgebraBoolean)(function(a){return H(c.value0)(a)<a.r*a.r})(a.stars))return!0;if(b.otherwise)return!1}throw Error("Failed pattern match at Main line 208, column 7 - line 209, column 7: "+[a.constructor.name,c.constructor.name]);}},n=function(a){return function(){h.setStrokeStyle("lightgreen")(e)();return a instanceof k.Cons?
b["void"](f.functorEff)(function(){h.beginPath(e)();h.moveTo(e)(a.value0.x)(a.value0.y)();r.for_(f.applicativeEff)(k.foldableList)(a.value1)(function(a){return h.lineTo(e)(a.x)(a.y)})();return h.stroke(e)()})():b["return"](f.applicativeEff)(b.unit)()}},z=function(a){return function(b){return function(c){if(c.space)c=y.value;else{if(c.space)throw Error("Failed pattern match at Main line 110, column 1 - line 225, column 28: "+[c.space.constructor.name]);c=w.value}return new u({path:a,level:b,direction:c})}}},
B=function(a){return function(c){return function(d){return function(e){var f;if(d)f=1;else{if(d)throw Error("Failed pattern match at Main line 163, column 13 - line 166, column 9: "+[d.constructor.name]);f=-1}e=J(b.ordNumber)(e)(50);var g={x:c.x+a.speed*e,y:c.y+f*a.speed*e};return b.bind(v.bindMaybe)(t.guard(v.monadPlusMaybe)(0.95>g.x||g.y<0.5-a.door/2||g.y>0.5+a.door/2))(function(){return b["return"](v.applicativeMaybe)(g)})}}}},A=function(a){return new x({path:k.Nil.value,nextLevel:a})},D=function(a){return function(c){return function(d){if(d instanceof
u&&d.value0.path instanceof k.Cons){if(l(q.fromJust(m.head(d.value0.level)))(d.value0.path))return new x({path:d.value0.path,nextLevel:d.value0.level});if(b["=="](b.eqBoolean)(b["=="](G)(d.value0.direction)(y.value))(a.space)){var e=B(q.fromJust(m.head(d.value0.level)))(d.value0.path.value0)(a.space)(c);if(e instanceof v.Just)return z(new k.Cons(e.value0,d.value0.path.value1))(d.value0.level)(a);if(e instanceof v.Nothing)return A(q.fromJust(m.tail(d.value0.level)));throw Error("Failed pattern match at Main line 110, column 1 - line 225, column 28: "+
[e.constructor.name]);}if(b.otherwise)return z(new k.Cons(d.value0.path.value0,new k.Cons(d.value0.path.value0,d.value0.path.value1)))(d.value0.level)(a)}if(d instanceof x){if(a.space)return d=d.value0.nextLevel,e={x:0.05,y:0.5},new u({path:k.toList(r.foldableArray)([e,e]),direction:w.value,level:d});if(!a.space)return d;throw Error("Failed pattern match at Main line 110, column 1 - line 225, column 28: "+[a.space.constructor.name]);}throw Error("Failed pattern match at Main line 110, column 1 - line 225, column 28: "+
[a.constructor.name,c.constructor.name,d.constructor.name]);}}},C=function(a){return b["void"](f.functorEff)(function(){var b=q.fromJust(m.head(a));return function(){h.setFillStyle("black")(e)();h.fillRect(e)({x:0,y:0,w:1,h:1})();h.setStrokeStyle("lightgreen")(e)();h.strokeRect(e)({x:0.05,y:0.25,w:0.9,h:0.5})();h.strokeRect(e)({x:0.045,y:0.24500000000000002,w:0.9099999999999999,h:0.51})();h.setFillStyle("lightgreen")(e)();h.fillRect(e)({x:0.045,y:0.5-b.door/2,w:0.005,h:b.door})();h.fillRect(e)({x:0.95,
y:0.5-b.door/2,w:0.005,h:b.door})();h.setFillStyle("#222")(e)();h.setStrokeStyle("lightgreen")(e)();return r.for_(f.applicativeEff)(k.foldableList)(b.stars)(function(a){var b=function(){h.arc(e)({x:a.x,y:a.y,r:a.r,start:0,end:2*d.pi})();return h.closePath(e)()};return function(){h.fillPath(e)(b)();return h.strokePath(e)(b)()}})()}}())},L=function(a){if(a instanceof x)return b["void"](f.functorEff)(function(){C(a.value0.nextLevel)();return n(a.value0.path)()});if(a instanceof u)return b["void"](f.functorEff)(function(){C(a.value0.level)();
return n(a.value0.path)()});throw Error("Failed pattern match at Main line 110, column 1 - line 225, column 28: "+[a.constructor.name]);},K=function(a){return function(){var c=s.nowEpochMilliseconds();L(a)();var d=p.readRef(g)();return E.requestAnimationFrame(function(){var e=s.nowEpochMilliseconds();return K(D(d)(b["-"](F.ringMilliseconds)(e)(c))(a))()})()}};return K(A(I))()}throw Error("Failed pattern match at Main line 110, column 1 - line 225, column 28: "+[a.constructor.name]);};a.levels=I;a.unsafeLevel=
C;a.clamp=J;a.decay=z;a.subtract=A;a.len2=D;a.dist2=H;a.eqDirection=G;a.onSpaceBar=c.onSpaceBar})(PS.Main=PS.Main||{});
