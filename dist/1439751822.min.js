...
k.Cons&&c.value1 instanceof k.Cons){if(0.25>=c.value0.y||0.75<=c.value0.y||0.95<c.value0.x&&(c.value0.y<0.5-a.door/2||c.value0.y>0.5+a.door/2)||s.any(k.foldableList)(b.booleanAlgebraBoolean)(function(a){return H(c.value0)(a)<a.r*a.r})(a.stars))return!0;if(b.otherwise)return!1}throw Error("Failed pattern match at Main line 213, column 7 - line 214, column 7: "+[a.constructor.name,c.constructor.name]);}},n=function(a){return function(){h.setStrokeStyle("lightgreen")(e)();return a instanceof k.Cons?
b["void"](f.functorEff)(function(){h.beginPath(e)();h.moveTo(e)(a.value0.x)(a.value0.y)();s.for_(f.applicativeEff)(k.foldableList)(a.value1)(function(a){return h.lineTo(e)(a.x)(a.y)})();return h.stroke(e)()})():b["return"](f.applicativeEff)(b.unit)()}},z=function(a){return function(b){return function(c){if(c.space)c=y.value;else{if(c.space)throw Error("Failed pattern match at Main line 107, column 1 - line 229, column 28: "+[c.space.constructor.name]);c=w.value}return new v({path:a,level:b,direction:c})}}},
B=function(a){return function(c){return function(d){return function(e){var f;if(d)f=1;else{if(d)throw Error("Failed pattern match at Main line 160, column 13 - line 163, column 9: "+[d.constructor.name]);f=-1}e=J(b.ordNumber)(e)(50);var g={x:c.x+a.speed*e,y:c.y+f*a.speed*e};return b.bind(r.bindMaybe)(u.guard(r.monadPlusMaybe)(0.95>g.x||g.y<0.5-a.door/2||g.y>0.5+a.door/2))(function(){return b["return"](r.applicativeMaybe)(g)})}}}},A=function(a){return new x({path:k.Nil.value,nextLevel:a})},D=function(a){return function(c){return function(d){if(d instanceof
...
throw Error("Failed pattern match at Main line 107, column 1 - line 229, column 28: "+[e.constructor.name]);}if(b.otherwise)return r.Just.create(z(new k.Cons(d.value0.path.value0,new k.Cons(d.value0.path.value0,d.value0.path.value1)))(d.value0.level)(a))}if(d instanceof x){if(a.space){e=r.Just;d=d.value0.nextLevel;var f={x:0.05,y:0.5};d=new v({path:k.toList(s.foldableArray)([f,f]),direction:w.value,level:d});return new e(d)}if(!a.space)return r.Nothing.value;throw Error("Failed pattern match at Main line 107, column 1 - line 229, column 28: "+
[a.space.constructor.name]);}throw Error("Failed pattern match at Main line 107, column 1 - line 229, column 28: "+[a.constructor.name,c.constructor.name,d.constructor.name]);}}},C=function(a){return b["void"](f.functorEff)(function(){var b=q.fromJust(m.head(a));return function(){h.setFillStyle("black")(e)();h.fillRect(e)({x:0,y:0,w:1,h:1})();h.setStrokeStyle("lightgreen")(e)();h.strokeRect(e)({x:0.05,y:0.25,w:0.9,h:0.5})();h.strokeRect(e)({x:0.045,y:0.24500000000000002,w:0.9099999999999999,h:0.51})();
...
return n(a.value0.path)()});if(a instanceof v)return b["void"](f.functorEff)(function(){C(a.value0.level)();return n(a.value0.path)()});throw Error("Failed pattern match at Main line 107, column 1 - line 229, column 28: "+[a.constructor.name]);};return function(a){var d=function(a){return function(){var e=t.nowEpochMilliseconds(),f=p.readRef(g)();return E.requestAnimationFrame(function(){var g=t.nowEpochMilliseconds();return function(){var h=D(f)(b["-"](F.ringMilliseconds)(g)(e))(a);if(h instanceof
r.Just)return function(){K(h.value0)();return d(h.value0)()};if(h instanceof r.Nothing)return c.onSpaceBarOnce(d(a));throw Error("Failed pattern match at Main line 107, column 1 - line 229, column 28: "+[h.constructor.name]);}()()})()}};return function(){K(a)();return d(a)()}}(A(I))()}throw Error("Failed pattern match at Main line 107, column 1 - line 229, column 28: "+[a.constructor.name]);};a.levels=I;a.unsafeLevel=C;a.clamp=J;a.decay=z;a.subtract=A;a.len2=D;a.dist2=H;a.eqDirection=G;a.onSpaceBarOnce=
c.onSpaceBarOnce;a.onSpaceBar=c.onSpaceBar})(PS.Main=PS.Main||{});
