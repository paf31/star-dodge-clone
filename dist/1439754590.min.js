...
f]),direction:w.value,level:d});return new e(d)}if(!a.space)return r.Nothing.value;throw Error("Failed pattern match at Main line 111, column 1 - line 233, column 28: "+[a.space.constructor.name]);}throw Error("Failed pattern match at Main line 111, column 1 - line 233, column 28: "+[a.constructor.name,c.constructor.name,d.constructor.name]);}}},C=function(a){return b["void"](f.functorEff)(function(){var b=q.fromJust(m.head(a));return function(){h.setFillStyle("#1B1C1B")(e)();h.fillRect(e)({x:0,y:0,
