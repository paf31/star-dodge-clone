...
(function(exports) {
  ...
  var unsafeLevel = function (level) {
      ...
      return unsafePure((function () {
          var speed = decay(8.999999999999999e-5)(1.2000000000000002e-4)(level);
  ...
  var main = function __do() {
      ...
      if (_9 instanceof Data_Maybe.Just) {
          ...
          var testCollision = function (level) {
              return function (_14) {
                  ...
                  throw new Error("Failed pattern match at Main line 203, column 7 - line 204, column 7: " + [ level.constructor.name, _14.constructor.name ]);
              };
          };
                  ...
                  return function (inputs) {
                      return new Playing({
                          ...
                          direction: (function () {
                              ...
                              throw new Error("Failed pattern match at Main line 105, column 1 - line 220, column 28: " + [ inputs.space.constructor.name ]);
                          })()
                      });
                  };
              };
                      ...
                      return function (_15) {
                          ...
                          if (Prelude.otherwise) {
                              var dy = (function () {
                                  ...
                                  throw new Error("Failed pattern match at Main line 159, column 17 - line 160, column 13: " + [ space.constructor.name ]);
                              })();
                              return new Data_Maybe.Just({
                                  x: pt.x + level.speed * _15, 
                                  y: pt.y + dy * level.speed * _15
                              });
                          };
                          throw new Error("Failed pattern match at Main line 105, column 1 - line 220, column 28: " + [ level.constructor.name, pt.constructor.name, space.constructor.name, _15.constructor.name ]);
                      };
                  };
              };
          };
                  ...
                  return function (_13) {
                      if (_13 instanceof Playing && _13.value0.path instanceof Data_List.Cons) {
                          ...
                          if (Prelude["=="](Prelude.eqBoolean)(Prelude["=="](eqDirection)(_13.value0.direction)(Up.value))(inputs.space)) {
                              var _48 = move(Data_Maybe_Unsafe.fromJust(Data_List_Lazy.head(_13.value0.level)))(_13.value0.path.value0)(inputs.space)(elapsed);
                              if (_48 instanceof Data_Maybe.Just) {
                                  return playing(new Data_List.Cons(_48.value0, _13.value0.path.value1))(_13.value0.level)(inputs);
                              };
                              if (_48 instanceof Data_Maybe.Nothing) {
                                  return initialState(Data_Maybe_Unsafe.fromJust(Data_List_Lazy.tail(_13.value0.level)));
                              };
                              throw new Error("Failed pattern match at Main line 105, column 1 - line 220, column 28: " + [ _48.constructor.name ]);
                          };
                          if (Prelude.otherwise) {
                      ...
                      throw new Error("Failed pattern match at Main line 105, column 1 - line 220, column 28: " + [ inputs.constructor.name, elapsed.constructor.name, _13.constructor.name ]);
                  };
              };
          };
          ...
          var render = function (_16) {
              ...
              throw new Error("Failed pattern match at Main line 105, column 1 - line 220, column 28: " + [ _16.constructor.name ]);
          };
      ...
      throw new Error("Failed pattern match at Main line 105, column 1 - line 220, column 28: " + [ _9.constructor.name ]);
  };
